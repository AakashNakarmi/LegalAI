...
export default function RentForm({ OpenEdit }: Props) {
                  ...
                  <FormControl isRequired>
                    <InputGroup>
                      <Input
                        ...
                        placeholder="Owner Permanent Address with Pincode"
                        onChange={handleInputChange}
                      />
                    </InputGroup>
                  </FormControl>
                  <FormControl isRequired>
                    <FormLabel>Tenant Details</FormLabel>
                  ...
                  <FormControl isRequired>
                    <InputGroup>
                      <Input
                        ...
                        placeholder="Tenant Permanent Address with Pincode"
                        onChange={handleInputChange}
                      />
                    </InputGroup>
                  </FormControl>
                  <FormControl isRequired>
                    <InputGroup>
                      <Input
                        ...
                        placeholder="Parent's Name (Father/Mother)"
                        onChange={handleInputChange}
                      />
                    </InputGroup>
                  </FormControl>
                  <FormControl isRequired>
                    ...
                    <InputGroup>
                      <Input
                        type="text"
                        name="rent_address"
                        value={formData.rent_address}
                        placeholder="Address of Property for Rent"
                        onChange={handleInputChange}
                      />
                    </InputGroup>
                  </FormControl>
                  ...
                  <FormControl isRequired>
                    <InputGroup>
                      <Input
                        ...
                        placeholder="Rent Period like 5/1/2023 - 5/11/2023"
                        onChange={handleInputChange}
                      />
                    </InputGroup>
                  </FormControl>
                  ...
                  <FormControl isRequired>
                    <InputGroup>
                      <Input
                        ...
                        value={formData.agreement_place}
                        placeholder="Place where Agreement took place"
                        onChange={handleInputChange}
                      />
                    </InputGroup>
                  </FormControl>
